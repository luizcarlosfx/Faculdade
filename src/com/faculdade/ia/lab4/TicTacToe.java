 ...
 * <p>
 *
 * In this game a position is represented by a white and black bitmask. A bit is
 * set if a position is ocupied. There are 9 squares so there are 1<<9 possible
 * positions for each side. An array of 1<<9 booleans is created, it marks all
